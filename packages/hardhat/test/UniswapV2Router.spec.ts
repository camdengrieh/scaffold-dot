...
describe("UniswapV2Router", () => {
  async function v2Fixture() {
    ...
    const [tokenAAddress, tokenBAddress, WETHAddress, factoryV2Address] = await Promise.all([
      tokenA.getAddress(),
      tokenB.getAddress(),
      WETH.getAddress(),
    ...
    const WETHPairAddress = await factoryV2.getPair(WETHAddress, await WETHPartner.getAddress());
  ...
  it("quote", async () => {
    ...
    await expect(router.quote(0n, 100n, 200n)).to.be.revertedWith("UniswapV2Library: INSUFFICIENT_AMOUNT");
    await expect(router.quote(1n, 0n, 200n)).to.be.revertedWith("UniswapV2Library: INSUFFICIENT_LIQUIDITY");
    await expect(router.quote(1n, 100n, 0n)).to.be.revertedWith("UniswapV2Library: INSUFFICIENT_LIQUIDITY");
  });
  ...
  it("getAmountOut", async () => {
    ...
    await expect(router.getAmountOut(0n, 100n, 100n)).to.be.revertedWith("UniswapV2Library: INSUFFICIENT_INPUT_AMOUNT");
    await expect(router.getAmountOut(2n, 0n, 100n)).to.be.revertedWith("UniswapV2Library: INSUFFICIENT_LIQUIDITY");
    await expect(router.getAmountOut(2n, 100n, 0n)).to.be.revertedWith("UniswapV2Library: INSUFFICIENT_LIQUIDITY");
  });
  ...
  it("getAmountIn", async () => {
    ...
    await expect(router.getAmountIn(0n, 100n, 100n)).to.be.revertedWith("UniswapV2Library: INSUFFICIENT_OUTPUT_AMOUNT");
    await expect(router.getAmountIn(1n, 0n, 100n)).to.be.revertedWith("UniswapV2Library: INSUFFICIENT_LIQUIDITY");
    await expect(router.getAmountIn(1n, 100n, 0n)).to.be.revertedWith("UniswapV2Library: INSUFFICIENT_LIQUIDITY");
  });
  ...
  it("getAmountsOut", async () => {
    ...
    await expect(router.getAmountsOut(2n, [await token0.getAddress()])).to.be.revertedWith(
  ...
  it("getAmountsIn", async () => {
    ...
    await expect(router.getAmountsIn(1n, [await token0.getAddress()])).to.be.revertedWith(
      "UniswapV2Library: INVALID_PATH",
    );
    const path = [await token0.getAddress(), await token1.getAddress()];
  ...
  it("removeLiquidity", async () => {
    ...
    await expect(
      ...
      .withArgs(500n, 2000n)
      .to.emit(pair, "Burn")
      .withArgs(await router02.getAddress(), token0Amount - 500n, token1Amount - 2000n, wallet.address);
  ...
  it("removeLiquidityETH", async () => {
    const { router02, wallet, WETHPartner, WETH, wethPair: WETHPair } = await loadFixture(v2Fixture);
    ...
    await expect(
      ...
      .to.emit(WETHPair, "Transfer")
      .withArgs(await WETHPair.getAddress(), ethers.ZeroAddress, expectedLiquidity - MINIMUM_LIQUIDITY)
      .to.emit(WETH, "Transfer")
      .withArgs(await WETHPair.getAddress(), await router02.getAddress(), ETHAmount - 2000n)
      .to.emit(WETHPartner, "Transfer")
      .withArgs(await WETHPair.getAddress(), await router02.getAddress(), WETHPartnerAmount - 500n)
      .to.emit(WETHPartner, "Transfer")
      .withArgs(await router02.getAddress(), wallet.address, WETHPartnerAmount - 500n)
  ...
  it("removeLiquidityETHWithPermit", async () => {
    const { router02, wallet, WETHPartner, wethPair, WETH } = await loadFixture(v2Fixture);
  ...
  describe("swapExactTokensForTokens", () => {
    ...
    it("happy path", async () => {
      ...
      await expect(
        ...
        .to.emit(pair, "Swap")
        .withArgs(await router02.getAddress(), swapAmount, 0, 0, expectedOutputAmount, wallet.address);
    });
  ...
  describe("swapTokensForExactTokens", () => {
    ...
    it("happy path", async () => {
      ...
      await expect(
        ...
        .to.emit(pair, "Swap")
        .withArgs(await router02.getAddress(), expectedSwapAmount, 0, 0, outputAmount, wallet.address);
    });
  ...
  describe("swapExactETHForTokens", () => {
    ...
    it("happy path", async () => {
      const { router02, token0, wallet, WETHPartner, wethPair: WETHPair, WETH } = await loadFixture(v2Fixture);
      ...
      await expect(
        ...
        .to.emit(WETH, "Transfer")
        .withArgs(await router02.getAddress(), await WETHPair.getAddress(), swapAmount)
        .to.emit(WETHPartner, "Transfer")
    ...
    it("gas", async () => {
      const { router02, token0, wallet, pair, WETHPartner, wethPair: WETHPair, WETH } = await loadFixture(v2Fixture);
  ...
  describe("swapTokensForExactETH", () => {
    ...
    it("happy path", async () => {
      const { router02, wallet, WETHPartner, wethPair: WETHPair, WETH } = await loadFixture(v2Fixture);
      ...
      await expect(
        ...
        .to.emit(WETH, "Transfer")
        .withArgs(await WETHPair.getAddress(), await router02.getAddress(), outputAmount)
        .to.emit(WETHPair, "Sync")
        .withArgs(
          WETHPairToken0 === (await WETHPartner.getAddress())
    ...
    it("amounts", async () => {
      const { router02, wallet, WETHPartner, wethPair: WETHPair, WETH, RouterEmit } = await loadFixture(v2Fixture);
      ...
      await WETHPartner.approve(await RouterEmit.getAddress(), ethers.MaxUint256);
      await expect(
  ...
  describe("swapExactTokensForETH", () => {
    ...
    it("happy path", async () => {
      ...
      await expect(
        ...
        .to.emit(WETH, "Transfer")
        .withArgs(await WETHPair.getAddress(), await router02.getAddress(), expectedOutputAmount)
        .to.emit(WETHPair, "Sync")
        .withArgs(
          WETHPairToken0 === (await WETHPartner.getAddress())
  ...
  describe("swapETHForExactTokens", () => {
    ...
    it("happy path", async () => {
      ...
      await expect(
        ...
        .to.emit(WETH, "Transfer")
        .withArgs(await router02.getAddress(), await WETHPair.getAddress(), expectedSwapAmount)
        .to.emit(WETHPartner, "Transfer")
